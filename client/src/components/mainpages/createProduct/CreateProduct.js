...
function CreateProduct() {
  ...
  const handleUpLoad = async (e) => {
    ...
    try {
      ...
      if(file.type !== 'image/ipeg'  && file.type !== 'image/png')
  ...
  const handleSubmit = async (e) => {
    ...
    try {
       if(!isAdmin) return  alert("You're not an admin")  
       if(!images)  return alert("No Imagw Upload")
  ...
  return (
    <div className="createProduct"> 
      <div className="createProduct__upload">
        <input type="file" name="file" id="file_up" onChange={handleUpLoad}/>
        {
          loading ? <div id="file_img"><Loading /></div> :
          <div className="createProduct__images" id="file_img" style={styleUpload} >
      ...
      <form onSubmit={handleSubmit} >
        <div className="createProduct__box">
        ...
        <div className="createProduct__box">
          ...
          <textarea type="text" name="content" id="content" required  value={product.content} onChange={handleChangeInput} rows="7"/>
        </div>
